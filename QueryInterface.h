...
#ifndef ASSIGNMENT_4_SEARCH_QUERYINTERFACE_H
#define ASSIGNMENT_4_SEARCH_QUERYINTERFACE_H
#include <sys/stat.h>
...
class QueryInterface(int argc, char* argv[]) {
...
#endif //ASSIGNMENT_4_SEARCH_QUERYINTERFACE_H
